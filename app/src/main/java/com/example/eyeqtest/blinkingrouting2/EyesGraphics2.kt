...
class EyesGraphics2(overlay: GraphicOverlay2) : GraphicOverlay2.Graphic(overlay) {
    ...
    private val mLeftPhysics: EyePhysics2 = EyePhysics2()
    private val mRightPhysics: EyePhysics2 = EyePhysics2()
