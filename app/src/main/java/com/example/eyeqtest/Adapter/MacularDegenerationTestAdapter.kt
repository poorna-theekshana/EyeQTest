...
class MacularDegenerationTestAdapter(private val testResults: List<MacularTestModal>) :
    RecyclerView.Adapter<MacularDegenerationTestAdapter.TestResultViewHolder>() {
