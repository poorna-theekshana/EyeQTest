...
class ContrastSensitivityTestAdapter(private val testResults: List<ContrastSensivityTestModal>) :
    RecyclerView.Adapter<ContrastSensitivityTestAdapter.TestResultViewHolder>() {
