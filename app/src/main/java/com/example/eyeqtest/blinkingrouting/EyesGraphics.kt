...
class EyesGraphics(overlay: GraphicOverlay) : GraphicOverlay.Graphic(overlay) {
    ...
    private val mLeftPhysics: EyePhysics = EyePhysics()
    private val mRightPhysics: EyePhysics = EyePhysics()
